...
import { ShieldAlert, Users, FileText, DollarSign, Activity, Lock, Unlock, UserCheck, Search, TrendingUp, AlertCircle, CheckCircle2 } from "lucide-react";
...
/**
 * AdminDashboardPage Component (Module 5: System Administration & Oversight)
 * Executive dashboard containing:
 *  - Item 16: Central Admin Metrics Panel
 *  - Item 17: User Moderation Management View
 */
export default function AdminDashboardPage() {
  ...
  // Change User Role (Learner vs Creator vs Admin)
  ...
  return (
    <div className="min-h-screen bg-[#F8F7FF] dark:bg-[#0b0a14] py-8 px-6 space-y-8">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-md bg-red-100 text-red-700 dark:bg-red-950/40 dark:text-red-300 text-xs font-bold mb-1">
              <ShieldAlert className="h-3.5 w-3.5" /> Module 5: Admin Control Panel
            </div>
            <h1 className="text-2xl font-extrabold text-gray-900 dark:text-white tracking-tight">
              Executive System Administration
            </h1>
            <p className="text-xs text-gray-500 mt-1">
              Platform-wide health metrics, transaction oversight, and user role moderation.
            </p>
          </div>
        </div>
        ...
        {/* Admin Alert Banner */}
        {adminNotification && (
          <div className="p-3.5 rounded-xl bg-indigo-500/10 border border-indigo-500/30 text-indigo-700 dark:text-indigo-300 text-xs font-medium flex items-center justify-between animate-fadeIn">
        ...
        <section className="space-y-4">
          <h2 className="text-lg font-bold text-gray-900 dark:text-white flex items-center gap-2">
            <Activity className="h-5 w-5 text-indigo-600 dark:text-indigo-400" /> Platform Overview & Health Metrics
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <Card className="border border-gray-200 dark:border-gray-800 bg-white dark:bg-[#121124] p-5 space-y-2">
              ...
              <p className="text-[11px] text-emerald-600 font-bold">Spring Boot API Healthy</p>
            </Card>
