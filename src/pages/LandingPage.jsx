    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans flex flex-col justify-between">
      ...
      <header className="bg-white border-b border-slate-100 px-6 py-4 sticky top-0 z-50">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-extrabold text-xl tracking-tight text-slate-800">LearnHub</span>
          </div>
          <div className="flex items-center gap-3">
            <Button variant="ghost" onClick={onLogin} className="text-xs font-semibold text-slate-600 hover:text-blue-600">
              Log In
            </Button>
            <Button onClick={onRegister} className="bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold px-4 py-2 rounded-lg">
              Sign Up
            </Button>
          </div>
        </div>
      ...
      <main className="flex-1 py-16 px-6">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-blue-50 text-blue-600 text-[11px] font-semibold">
            <Sparkles className="h-3.5 w-3.5" /> Learner-Focused Content Platform
          </div>

          <h1 className="text-4xl sm:text-5xl font-black tracking-tight text-slate-900 leading-tight">
            Learn Faster with Curated <br />
            <span className="text-blue-600">Notes, Guides & Code</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-4">
            <Button
              onClick={onExplore}
              className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs px-6 py-5 rounded-lg shadow-sm gap-2"
            >
            ...
            <Button
              variant="outline"
              onClick={onRegister}
              className="w-full sm:w-auto border-slate-200 text-slate-700 hover:bg-slate-100 font-bold text-xs px-6 py-5 rounded-lg gap-1.5"
            >
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 text-[11px] text-slate-400 pt-8 border-t border-slate-100 max-w-md mx-auto">
            ...
            <span className="flex items-center gap-1.5"><Users className="h-4 w-4 text-blue-500" /> 1:1 Live Doubts</span>
          </div>
