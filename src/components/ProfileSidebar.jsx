      ...
      <CardFooter className="bg-slate-50/50 dark:bg-slate-900/50 p-4 border-t border-slate-100 dark:border-slate-800 rounded-b-xl">
        <div className="grid grid-cols-2 w-full text-center divide-x divide-slate-100 dark:divide-slate-800">
          {activeRole === "ADMIN" ? (
            <>
              <div>
                <div className="text-lg font-bold text-red-600 dark:text-red-400">142</div>
                <div className="text-xs text-gray-500 uppercase font-semibold">Users</div>
              </div>
              <div>
                <div className="text-lg font-bold text-red-600 dark:text-red-400">24</div>
                <div className="text-xs text-gray-500 uppercase font-semibold">Items</div>
              </div>
            </>
          ) : activeRole === "LEARNER" ? (
            <>
